...
import { profile_get_data, updateProfile } from '../../store/actions/profile';
...
const mapDispatchToProps = (dispatch) => {
    return {
        getFullProfile: () => dispatch(profile_get_data()),
...
export default compose(
    ...
    withFormik({
        ...
        mapPropsToValues: (props) => {
            const {
                profile: { fullName, address, note, imageUrl, dob, email, role },
      } = props;
      return {
        fullName: fullName || '',
        email,
